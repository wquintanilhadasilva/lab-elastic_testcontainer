...
import com.elastic.testcontainer.demo.template.CustomElasticSearchContainer;
...
public class DefaultBookServiceIT {
    ...
    @Container
    private static final ElasticsearchContainer elasticsearchContainer = new CustomElasticSearchContainer();
